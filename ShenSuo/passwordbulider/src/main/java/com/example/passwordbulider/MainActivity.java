package com.example.passwordbulider;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.e(TAG, "onClick: "+getPW(1,0,0,10));
                Log.e(TAG, "onClick: "+getPW(0,1,0,10));
                Log.e(TAG, "onClick: "+getPW(0,0,1,10));
                Log.e(TAG, "onClick: "+getPW(1,1,0,10));
                Log.e(TAG, "onClick: "+getPW(1,0,1,10));
                Log.e(TAG, "onClick: "+getPW(0,1,1,10));
                Log.e(TAG, "onClick: "+getPW(1,1,1,10));
                Log.e(TAG, "onClick: ************************************************" );
            }
        });
    }
    ...
    private String getPW(int s,int n,int l,int pwlength){
